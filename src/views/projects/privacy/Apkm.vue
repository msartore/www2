<template>
  ...
  <p>
    ...
    (hereby referred to as "Service Provider") as an Ad Supported service. This
  ...
  <p>
    ...
    contact them at me@msartore.dev and they will respond in a reasonable time.
  </p>
  ...
  <div>
    ...
    <p>
      ...
      (me@msartore.dev) so that they will be able to take the necessary actions.
    </p>
  </div>
  ...
  <br />
  <p>This privacy policy is effective as of 2025-10-26</p>
...
useHead({
  title: "Privacy Policy | APKM",
  meta: [
    {
      name: "description",
      content: "Read the privacy policy for the the APKM app.",
    },
    {
      property: "og:title",
      content: "Privacy Policy | APKM",
    },
    {
    ...
    {
      property: "og:url",
      content: "https://msartore.dev/projects/apkm/privacy",
    },
  ],
});
</script>
