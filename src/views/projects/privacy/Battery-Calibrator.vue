<template>
  ...
  <p>
    ...
    mandatory. However, bear in mind that you might not be able to utilize some
    of the features offered by the Application unless you register with them.
  </p>
  <p>
  ...
  <p>
    ...
    mobile devices unique device ID, the IP address of your mobile device, your
  ...
  <p>
    This Application does not gather precise information about the location of
    your mobile device.
  </p>
  <div style="display: none">
    <p>
      This Application collects your device's location, which helps the Service
  ...
  <p>
    ...
    uninstalling the Application. You may use the standard uninstall processes
  ...
  <p>
    ...
    procedural safeguards to protect information we process and maintain. For
    example, we limit access to this information to authorized employees and
    contractors who need to know that information in order to operate, develop
    or improve their Application. Please be aware that, although we endeavor
  ...
  <p>
    ...
    now and as amended by us. "Processing,” means using cookies on a
